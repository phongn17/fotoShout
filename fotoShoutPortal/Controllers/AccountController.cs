...
namespace FotoShoutPortal.Controllers {
    ...
    public class AccountController : Controller {
        ...
        private FsApiWebService _fsWebService = new FsApiWebService(AppConfigs.ApiBaseAddress, AppConfigs.ApiPrefix, FotoShoutUtils.Constants.MEDIATYPE_APPLICATION_JSON);
        //
        // GET: /Account/Login
            ...
            try {
                if (ModelState.IsValid) {
                    if (Login(model)) {
                        ...
                        this.AddModelError(Errors.ERROR_AUTH_NOUSER, _logger);
                }
                else {
                ...
                this.AddModelError(Errors.ERROR_CREDENTIALS_INVALID, _logger, ex);
            }
        ...
        public ActionResult Logoff(string userName) {
            return PartialView("_LogoffConfirmation", userName);
        }
        ...
        public ActionResult LogOff() {
            ...
            Session[Constants.FS_AUTHORIZATION] = null;
